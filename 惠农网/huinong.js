...
console.log(time)
    ...
    function get_nonce(t) {
        return (t ? "xxxxxxxxxxxxxyxxxxyxxxxxxxxxxxxx" : "xxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxx").replace(/[xy]/g, (function (t) {
                var n = (time + 16 * Math.random()) % 16 | 0;
                return e = Math.floor(time / 16),
    ...
    h = get_client_id(time, 9)
    d = get_client_id(randint(0, 78364164095), 7)
    v = "S_" + h + d;

    TRACEID = get_client_id(time, 9) + get_client_id(randint(0, 78364164095), 7)
    ...
    k = j
    C = ""
    C = cryptoSha1(x + k).toString()
// console.log("C:::", C)
// C = C[$("0x5f", "GEhp") + "str" + $("0x4b", "@ycV")](C[$("0x44", "oChJ") + $("0x25", "azqg")] - 16, C[$("0x55", "9Ynf") + $("0x1f", "3MMx")] - 1),
    C = C["substring"](C["length"] - 16, C["length"] - 1)
    console.log("C:::", C)

// D = h["fromString"](C, !0, 16)["toUnsigned"]()["toString"](10)
    D = window.fromString(C, !0, 16)["toUnsigned"]()["toString"](10)
    console.log("D:::", D)
    A = [L, B, N, D]
